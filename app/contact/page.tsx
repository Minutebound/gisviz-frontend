...
export default function ContactPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-12">
      ...
      <p className="text-[15px] text-gisviz-ink-soft font-sans mb-12 leading-relaxed">
      ...
      <div className="space-y-4">
        ...
        <div className="bg-gisviz-card border border-gisviz-border rounded-sm p-6 flex flex-col sm:flex-row sm:items-center gap-4">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-[15px] font-bold text-gisviz-ink mb-1">Support ticket</p>
            <p className="text-[13px] font-mono text-gisviz-ink-soft leading-relaxed">
          ...
          <button
            ...
            className="shrink-0 flex items-center gap-2 bg-gisviz-accent text-gisviz-white px-5 py-2.5 rounded-md font-mono text-[13px] font-bold hover:bg-opacity-90 transition-all shadow-sm"
          >
        ...
        <div className="bg-gisviz-card border border-gisviz-border rounded-sm p-6 flex flex-col sm:flex-row sm:items-center gap-4">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-[15px] font-bold text-gisviz-ink mb-1">General enquiries</p>
            <p className="text-[13px] font-mono text-gisviz-ink-soft leading-relaxed">
          ...
          <a
            ...
            className="shrink-0 flex items-center gap-2 border border-gisviz-border text-gisviz-ink px-5 py-2.5 rounded-md font-mono text-[13px] hover:border-gisviz-accent hover:text-gisviz-accent transition-colors"
          >
            <Mail size={14} />
            info@gisviz.com
          </a>
        ...
        <div className="bg-gisviz-card border border-gisviz-border rounded-sm p-6 flex flex-col sm:flex-row sm:items-center gap-4">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-[15px] font-bold text-gisviz-ink mb-1">Security vulnerabilities</p>
            <p className="text-[13px] font-mono text-gisviz-ink-soft leading-relaxed">
